  ...
  <div class="modal-content">
   ...
   <div class="modal-body">
    <form>
     ...
     <div class="form-group">
      <label for="m666" class="control-label">666:</label>
      <input type="text" class="form-control" id="m666">
     </div>
     <div class="form-group">
      <label for="m999" class="control-label">999:</label>
      <textarea class="form-control" id="m999"></textarea>
     </div>
    </form>
   </div>
